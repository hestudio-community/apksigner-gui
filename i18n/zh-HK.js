export default {
  ...
  backup: "備份",
  restore: "恢復",
  backupSuccess: "設定檔備份成功",
  restoreSuccess: "設定檔恢復成功",
  restoreError: "設定檔恢復失敗",
  backupError: "設定檔備份失敗",
  anotherAlreadyRunning: "另一個進程正在運行，本進程將退出。",
  latestVersion: "你現在使用的是最新版本。",
  ...
  warnInARM64WithX86Program:
    "你現在正在 arm64 平台中通過轉譯的方式運行基於 x86 的應用程式，我們已經提供了原生 arm64 應用程式，請前往 Github 中查看。",
  version: "版本",
  platform: "平台",
  architecture: "架構",
  workStatus: "工作狀態",
  copyright: "版權",
  checkUpdate: "檢查更新",
  aboutApp: "關於 APKSignerGUI",
  reportIssue: "報告問題",
  JavaEnvConfiguration: "Java環境配置",
  CheckAndSave: "檢查並儲存",
  AutoLoadJavaInSystem: "自動從系統中讀取Java環境",
  JavaPath: "Java路徑",
  JavaEnvConfigurationNormalMsg: (javapath, keytoolpath) => {
    return `<p>環境配置正常</p><p>Java路徑: ${javapath}</p><p>keytool路徑: ${keytoolpath}</p>`;
  },
  JavaEnvConfigurationNormal: "Java環境配置正常",
  JavaEnvConfigurationFailed:
    "Java環境異常，請檢查Java是否存在或者是否附帶keytool",
};
